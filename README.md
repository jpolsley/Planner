...
1. **Settings → Secrets and variables → Actions → New repository secret.** Name it `STERWARD_PASSWORD` and give it a value of at least 8 characters.
...
To test the locked build locally: `STERWARD_PASSWORD='something-long' node tools/lock.mjs`, then open `http://localhost:8000/dist/`.
